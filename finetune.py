...
from reader.pmr_finetuning import PMRDataJointReader
...
READERS = {"vcr": VCRDataJointReader, "refcoco_plus": RefcocoPlusDataReader, 
           "flickr": FlickrDataReader, "vqa": VQADataReader,"pmr":PMRDataJointReader}
...
MODELS = {"vcr": create_vcr_model, "refcoco_plus": create_refcoco_plus_model, 
          "flickr": create_flickr_model, "vqa": create_vqa_model,"pmr":create_pmr_model}
...
def predict_wrapper(args,
    ...
    def predict_pmr(exe=exe, pyreader=pyreader):
        """
            inference for vcr tasks
        """
        pyreader.decorate_tensor_provider(data_reader.data_generator())
