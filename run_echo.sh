...
echo -------------------------------------
echo --use_cuda True
echo --is_distributed "False"
echo --use_fast_executor ${e_executor-"True"}
echo --nccl_comm_num ${nccl_comm_num:-"1"}
echo --batch_size $((BATCH_SIZE))
echo --do_train "True"
echo --do_test "False"
echo --task_name ${TASK_NAME}
echo --vocab_path, ${VOCAB_PATH}
echo --task_group_json, ${TASK_GROUP_JSON}
echo --lr_scheduler, ${lr_scheduler}
echo --decay_steps, ${decay_steps-""}
echo --lr_decay_ratio, ${lr_decay_ratio-0.1}
echo --layer_decay_rate, ${layer_decay_rate-0.0}
echo --text_init_layers, ${text_init_layers-18}
echo --n_layers, ${n_layers-30}
echo --margin, ${margin-0.3}
echo --num_train_steps, ${num_train_steps}
echo -checkpoints, $output_model_path
echo --save_steps, ${SAVE_STEPS}
echo --init_checkpoint, ${PRETRAIN_MODELS}
echo --ernie_config_path, ${ERNIE_VIL_CONFIG}
echo --learning_rate, ${LR_RATE}
echo --warmup_steps, ${WARMUP_STEPS}
echo --weight_decay ${WEIGHT_DECAY:-0}
echo --max_seq_len, ${MAX_LEN}
echo --save_steps, 10
